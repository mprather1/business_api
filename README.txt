...
4. rails s
*you may have to use 'bundle exec rake db:migrate' and 'bundle exec rake import:businesses'

"curl http://localhost:3000/api/v1/businesses" will return an index of business names with 50 businesses on each page, ids are included for reference but can be removed by editing app/serializers/index_serializer.rb
